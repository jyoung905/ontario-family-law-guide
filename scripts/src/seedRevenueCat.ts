...
const PROJECT_NAME = "Ontario Family Law Guide";
...
const APP_STORE_APP_NAME = "Ontario Family Law Guide iOS";
const APP_STORE_BUNDLE_ID = "com.ontariofamilylaw.guide";
const PLAY_STORE_APP_NAME = "Ontario Family Law Guide Android";
const PLAY_STORE_PACKAGE_NAME = "com.ontariofamilylaw.guide";
...
// $9.99/month — competitive with legal info apps (RevenueCat SOSA 2026 benchmark)
